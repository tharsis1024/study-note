...
### 20223.11.1-###2023.11.6
继续准备取证题目 
最近偶尔还看看iot 免得时间太长忘记了

### 2023.11-7-11.15
这个周练习pwn和re 跟着刷一下ctf
赶紧打完比赛去搞搞实战
### 2023.11.16-11.29
刷刷ctf 看些iot复现
### 2023.12.22
比完赛了 接下来就可以回归正常学习进度了
...
再根据以上基础重新写个先22诊断 正面回应后再进行2E的脚本

### 2025.11.28
火速更新...
已完成基础NFC的相关学习,需要再看看14443和15693和7816nfc的部分
回头可以再看看ISO7816关于SIM的部分
最近还抓到了一些关于CCCDK 3.0的流量 可以详细拆拆这段流量包,顺便研究一下怎么才能写个插件直接过滤出交换SPAKE2+以及CCCDK交换密钥和协商完成DHKey的流量 拿这个当依据判断CCC实现是否安全这种
